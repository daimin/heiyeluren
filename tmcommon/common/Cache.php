...
class Cache {
   ...
   /**
     ...
     * construct
     */
    function Cache($param = array(), $cacheType = CACHE_TYPE_MEM){
        switch ($cacheType) {
            ...
            case CACHE_TYPE_MEM:
                $param = empty($param) ? array(array(MEMCACHE_HOST, MEMCACHE_PORT)) : $param;
				if (!defined(MEMCACHE_HOST) || !defined(MEMCACHE_PORT)){
					exit('Error: init Memcache failed, please defaine "MEMCACHE_HOST" and "MEMCACHE_PORT".');
				}
